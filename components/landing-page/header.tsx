        ...
        <NavigationMenuList className="gap-6">
          ...
          <NavigationMenuLink
            className={cn(navigationMenuTriggerStyle(), {
              "dark:text-white cursor-pointer": path === "#testimonials",
              "dark:text-white/40 cursor-pointer": path !== "#testimonials",
              "font-normal": true,
              "text-xl": true,
            })}
    ...
    return (
      <li>
        <NavigationMenuLink asChild>
          <a
            ref={ref}
            className={cn("group block select-none space-y-1 font-medium leading-none", className)}
            {...props}
          >
